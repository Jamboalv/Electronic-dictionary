...
root.title("电子词典系统-在线翻译-中译英")   # root = Tk(className='电子词典系统')
...
fram = Frame(root)
Label(fram,text='输入中文：'.decode('utf8').encode('utf8'), font=('Helvetica', '10', 'bold')).pack(side=LEFT)
#单行输入文本框
...
edit.pack()
#翻译按钮
butt = Button(fram, text='在线翻译',background='lightgreen')
